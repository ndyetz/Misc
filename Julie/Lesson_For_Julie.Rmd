...
mutate() "mutates" variables to get you something interesting. You can use this to rename variables, factor variables, do simple math calculations, etc. etc. Here, you'll be using the "=" sign. The "=" sign is telling the mutate function you want to create a new variable. You can even just set it to 1 value  I'll show you the general outline for the mutate function.
